...
namespace SDEVH.Migrations
{
    ...
    [Migration("20240415055000_usuariosregistrohistorialtest2")]
    partial class usuariosregistrohistorialtest2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SDEVH.Models.UsuarioHistorial", b =>
                {
                    ...
                    b.Property<Guid?>("RegistradoPorUsuarioUsuarioId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("IdRegistroUsuario");

                    b.HasIndex("RegistradoPorUsuarioUsuarioId");
            ...
            modelBuilder.Entity("SDEVH.Models.UsuarioHistorial", b =>
                {
                    b.HasOne("SDEVH.Models.Usuario", "RegistradoPorUsuario")
                        ...
                        .HasForeignKey("RegistradoPorUsuarioUsuarioId");
